...
public class DateTimeUtils {
  ...
  public static final String YYYYMMDDHHHHSSFormat = "yyyy-MM-dd HH:mm:ss";
   ...
   * @return
   */
  public static Date getDataTimeForword(Date date,
                                        int dayNum) {
   ...
   * @return
   */
  public static Date getDataTimeForwordLastsecond(Date date,
                                                  int dayNum) {
    Calendar cal = Calendar.getInstance();
    cal.setTime(date);
   ...
   * @return
   */
  public static Date getDataTimeForwordStartsecond(Date date,
                                                   int dayNum) {
    Calendar cal = Calendar.getInstance();
    cal.setTime(date);
  ...
  public synchronized static Date getDataTimeForword(String date,
                                                     int num,
                                                     String type) throws ParseException {
    return getDataTimeForword(getToDateObject(date), num, type);
  }
   ...
   * @return
   */
  public static int getOddDateNum(String beginTime,
   ...
   */
  public static List<String> getTimeList(String timeBegin,
                                         String timeEnd) throws ParseException {
  ...
  public static String getFullDate() {
    return new SimpleDateFormat("yyyyMMdd").format(getDataTimeForword(new Date(),
                                                                      -1));
  }
  ...
  public static String getFullDate(Date date) {
    return new SimpleDateFormat("yyyy-MM-dd").format(getDataTimeForword(date,
                                                                        -1));
  }
   ...
   * if dataStr == null then get_now
   */
  public static Long getCurrentTimeMillis(String dataStr) throws ParseException {
    if (dataStr == null) {
      return new Date().getTime();
    }
   ...
   * @return
   */
  public static String convertDateTimeFormat(String dateStr,
                                             String oldFormat,
   ...
   * 时间转换
   **/
  public static Date convertDateTimeFormat(String dateStr,
   ...
   * 判断时间范围
   **/
  public static boolean timeRangeCheck(String startTime,
                                       String endTime,
                                       Date checkDate,
                                       String format) throws ParseException {
  ...
  public static boolean timeRangeCheck(String startTime,
    ...
    Date start = convertDateTimeFormat(startTime, YYYYMMDDHHHHSSFormat);
    Date end = convertDateTimeFormat(endTime, YYYYMMDDHHHHSSFormat);
    return timeRangeCheck(start, end, checkDate);
  }
   ...
   **/
  public static boolean timeRangeCheck(Date startTime,
                                       Date endTime,
                                       Date checkDate) {
    if (checkDate.getTime() == startTime.getTime()
   ...
   * @return
   */
  public static Long dateCompare(String beginTime,
                                 String endTime,
                                 String format,
                                 String type) throws ParseException {
  ...
  public static String getNextDay(String date,
                                  int settleCycle) throws ParseException {
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    Calendar calendar = Calendar.getInstance();
  ...
  public static boolean compare(String time1,
                                String time2) throws ParseException {
  ...
  public static void main(String[] args) {
    try {
      System.out.println(getDataTimeForword(new Date(), 80, "秒"));
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
